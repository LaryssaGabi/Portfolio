  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...selectedProject,
        // Corrige a inconsistência do GitHub/Github
        Github: selectedProject.GitHub || selectedProject.Github || 'https://github.com/LaryssaGabi',
        ...
        // Remove espaços extras no título
