...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/laryssa-gabriela-alves/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@laryssagabriela7",
    icon: Instagram,
    url: "https://www.instagram.com/laryssagabriela7/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Laryssa",
    icon: Github,
    url: "https://github.com/LaryssaGabi",
    color: "#ffffff",
